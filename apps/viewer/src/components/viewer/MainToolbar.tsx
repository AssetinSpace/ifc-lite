...
import {
  ...
  Puzzle,
  Palette,
  // >>> AIM-FORK: icon for the Drawing Underlays panel toggle (D-072)
  Map as MapIcon,
  // <<< AIM-FORK
  Orbit,
  Layout,
...
// >>> AIM-FORK: 3D | 2D | Split workspace view mode switcher (D-075)
    ...
    <div className="flex items-center gap-1 px-2 h-12 border-b bg-white dark:bg-black border-zinc-200 dark:border-zinc-800 relative z-50">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="start" className="w-56">
          ...
          {/* >>> AIM-FORK: Drawing Underlays panel toggle (D-072). Deliberately
              NOT handleToggleRightPanel — that helper is typed to RightPanel and
              is mutually exclusive; this panel coexists with the others. */}
          <DropdownMenuCheckboxItem
      ...
      */}
      ...
      {/* >>> AIM-FORK: D-075 workspace view mode: 3D | 2D | Split + storey picker. */}
      <ViewModeSwitcher />
      {/* <<< AIM-FORK */}
